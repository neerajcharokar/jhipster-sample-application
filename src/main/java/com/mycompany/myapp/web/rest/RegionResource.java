...
public class RegionResource {
    ...
    private static final String ENTITY_NAME = "jhipsterSampleApplicationRegion";
    ...
    public ResponseEntity<Region> updateRegion(@PathVariable(value = "id", required = false) final String id, @RequestBody Region region)
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, region.getId()))
            .body(result);
    }
    ...
    public ResponseEntity<Region> partialUpdateRegion(
        ...
        return ResponseUtil.wrapOrNotFound(result, HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, region.getId()));
    }
